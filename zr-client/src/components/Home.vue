  ...
  <div id="module">
    <el-container>
      <el-aside width="auto">
        ...
        <div v-show="!isCollapse" class="title" style="display: inline-block;">强哥国际</div>
  ...
  export default {
    ...
    methods: {
      menu(commentName, menuIndex, breadcrumbTitle, breadcrumbIndex) {
        this.$store.commit('menuIndex', menuIndex);//激活菜单
        this.$store.commit('breadcrumbTitle', breadcrumbTitle);//一级菜单
        this.$store.commit('breadcrumbIndex', breadcrumbIndex);//二级菜单
